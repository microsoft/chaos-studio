...
|---|---|---|
| [`aks-zone-down-demo/`](aks-zone-down-demo/) | Deploy a sample retail app to a zone-redundant AKS cluster, take down an availability zone and watch the app break on a live browser dashboard, then fix the deployment and rerun to prove it survives. | ~45 min |
