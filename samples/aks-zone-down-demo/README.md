...
### Push-button deploy with GitHub Actions

If your team already connects GitHub to Azure with OIDC, you can run the setup
...
No OIDC set up yet? The Cloud Shell path above is faster - the one-time
federated-credential setup only pays off if you'll run this repeatedly.
